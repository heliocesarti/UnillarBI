...
export default function Topbar({ title, subtitle, filial, onFilialChange, showSync, syncStatus, onSincronizar, showLimparFiltros, onLimparFiltros, mostrarFiltroFilial = true }) {
  return (
    <header className="topbar">
      ...
      <div className="user-chip">
        ...
        <div className="who"><b>Hélio Cesar</b><span>TI</span></div>
      </div>
    </header>
  );
}
